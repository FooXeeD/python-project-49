...
def my_prime():
    ...
    if f_num == 'yes' and number_prime is True or f_num == 'no' and number_prime is False:
        ...
        if f_num2 == 'yes' and number_prime2 is True or f_num2 == 'no' and number_prime2 is False:
            ...
            elif f_num3 == 'yes' and number_prime3 is False or f_num3 == 'no' and number_prime3 is True:
                print("'yes' is wrong answer ;(. Correct answer was 'no'.")
                print("Let's try again, " + name + "!")
            else:
                print("'" + str(f_num3) + "' is wrong answer ;(. Correct answer was 'no'.")
                print("Let's try again, " + name + "!")
        elif f_num2 == 'yes' and number_prime2 is False or f_num2 == 'no' and number_prime2 is True:
            print("'yes' is wrong answer ;(. Correct answer was 'no'.")
            print("Let's try again, " + name + "!")
        else:
            print("'" + str(f_num2) + "' is wrong answer ;(. Correct answer was 'no'.")
            print("Let's try again, " + name + "!")
    elif f_num == 'yes' and number_prime is False or f_num == 'no' and number_prime is True:
        print("'yes' is wrong answer ;(. Correct answer was 'no'.")
        print("Let's try again, " + name + "!")
    else:
